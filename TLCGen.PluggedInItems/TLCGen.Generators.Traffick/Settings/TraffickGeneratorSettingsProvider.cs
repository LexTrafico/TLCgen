...
namespace TLCGen.Generators.Traffick.Settings
{
    // TODO this overlaps with CCOL gen > merge!
    public class TraffickGeneratorSettingsProvider : ICCOLGeneratorSettingsProvider
    {
        private static ICCOLGeneratorSettingsProvider _default;
        public static ICCOLGeneratorSettingsProvider Default => _default ??= new TraffickGeneratorSettingsProvider();

        private Dictionary<CCOLElementTypeEnum, string> _lastItemDescription;

	    public TraffickGeneratorSettingsProvider()
        {
		...
		public string GetElementDescription(string description, CCOLElementTypeEnum type, params string [] elementnames)
		{
            ...
            if (!TraffickGeneratorSettingsProvider.Default.Settings.ReplaceRepeatingCommentsTextWithPeriods) return descr;
        ...
        public CCOLElement CreateElement(string name, int setting, CCOLElementTimeTypeEnum timeType, CCOLGeneratorCodeStringSettingModel element, params string [] elementnames)
        {
            ...
            return new CCOLElement(name, setting, timeType, t, this,
        ...
        {
            var t = TranslateType(element.Type);
            return new CCOLElement(name, t, this,
                    GetElementDescription(element.Description, t, elementnames));
        }

        public CCOLElement CreateElement(string name, CCOLElementTypeEnum type, string description)
        {
            return new CCOLElement(name, type, this, GetElementDescription(description, type));
        }
        ...
        {
            return new CCOLElement(name, setting, timeType, type, this, GetElementDescription(description, type));
        }
