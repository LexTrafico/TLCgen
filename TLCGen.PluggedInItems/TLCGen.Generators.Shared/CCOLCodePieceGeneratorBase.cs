...
namespace TLCGen.Generators.Shared
{
    ...
    public abstract class CCOLCodePieceGeneratorBase : ICCOLCodePieceGenerator
    {
        ...
        public virtual void CollectCCOLElements(ControllerModel c, ICCOLGeneratorSettingsProvider settingsProvider = null)
        {
        ...
        public virtual bool SetSettings(CCOLGeneratorClassWithSettingsModel settings, ICCOLGeneratorSettingsProvider settingsProvider)
        {
            ...
            _hpf = settingsProvider.GetPrefix("h");
            _mpf = settingsProvider.GetPrefix("m");
            _tpf = settingsProvider.GetPrefix("t");
            _ctpf = settingsProvider.GetPrefix("c");
            _schpf = settingsProvider.GetPrefix("sch");
            _prmpf = settingsProvider.GetPrefix("prm");
            ...
            {
                var type = settingsProvider.GetDefaultPrefix(s.Type);
