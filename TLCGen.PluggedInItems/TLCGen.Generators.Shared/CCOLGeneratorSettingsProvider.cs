...
{
    public class CCOLGeneratorSettingsProvider : ICCOLGeneratorSettingsProvider
    {
        private static ICCOLGeneratorSettingsProvider _default;
        public static ICCOLGeneratorSettingsProvider Default => _default ??= new CCOLGeneratorSettingsProvider();
